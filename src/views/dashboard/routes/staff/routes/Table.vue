<template>
  <v-row justify="space-between" class="my-10">
    <v-col cols="12">
      <v-btn elevation="3" class="mb-4" to="/dashboard/staffs/create">
        <v-icon class="mr-2">mdi-account-plus</v-icon>
        <span class="text-capitalize">Create New</span>
      </v-btn>
      <v-btn elevation="3" class="ml-4 mb-4 bg-indigo" to="/dashboard/staffs/createStaffRole">
        <v-icon class="mr-2">mdi-account-lock</v-icon>
        <span class="text-capitalize">Create Staff Roll</span>
      </v-btn>
      <v-btn elevation="3" class="ml-4 mb-4 bg-indigo" to="/dashboard/staffs/createDepartment">
