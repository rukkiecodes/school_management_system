<template>
  <v-row justify="space-between" class="my-10">
    <v-col cols="12">
      <v-btn
        class="mb-4 bg-indigo-accent-4"
        to="/admin/accountingItems/createCategoies"
      >
                  ...
                  <v-menu activator="parent">
                    <v-list width="130" density="compact" class="pa-0 ma-0">
                      <v-list-item
                        ...
                        @click="fillCategoryForm(category)"
                      >
                        ...
                        >
                          <v-card>
                            ...
                            <v-card-text>
                              ...
                              />
                              <v-select
                                v-model="updateCategory.maincategory"
                            ...
                            <v-card-actions>
                              <v-btn
                                block
                                @click="updateCategoryItem(category)"
                      ...
                      <v-list-item
                        style="cursor: pointer"
                        :to="`/admin/accountingItems/${category?.id}`"
                      >
                        <v-list-item-title class="text-body-2"
                          ...
                          <v-card>
                            ...
                            <v-card-actions>
                              <v-btn
                                ...
                                :loading="deleteSingleCategory.loading"
                                >Delete</v-btn
                              >
                            </v-card-actions>
                          </v-card>
